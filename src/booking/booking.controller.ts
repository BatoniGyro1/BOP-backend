...
export class BookingController {
  ...
  @Post()
  create(@Body() createBookingDto: CreateBookingDto, @Req() req): Promise<BookingResponseDto> {
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateBookingDto: UpdateBookingDto, @Req() req): Promise<BookingResponseDto> {
